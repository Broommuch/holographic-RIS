...
\begin{figure}[t]
    \centering
    \subfloat[]{%
        \includegraphics[width=0.48\linewidth]{simulation_results/ch5_spatial_reference_consistent_2026/results/fig_spatial_pilot_recovery_probability.eps}%
    }
    \hfill
    \subfloat[]{%
        \includegraphics[width=0.48\linewidth]{simulation_results/ch5_spatial_reference_consistent_2026/results/fig_spatial_pilot_channel_nmse.eps}%
    }
...
\begin{figure}[t]
    \centering
    \subfloat[]{%
        \includegraphics[width=0.48\linewidth]{simulation_results/ch5_spatial_reference_consistent_2026/results/fig_spatial_stability_channel_nmse.eps}%
    }
    \hfill
    \subfloat[]{%
        \includegraphics[width=0.48\linewidth]{simulation_results/ch5_spatial_reference_consistent_2026/results/fig_spatial_stability_pilot_overhead.eps}%
    }
