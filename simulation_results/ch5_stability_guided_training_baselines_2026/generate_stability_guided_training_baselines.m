%% Stability-guided adaptive training with practical algorithmic baselines
clc;
clear;
close all;
...
[S_full, B_full] = build_four_phase_training(pilot_cycles_full, cfg_full);
...
fprintf(['RIS %d x %d, users %d, pilot measurements %d--%d, ', ...
...
box on;
xlabel('Training SNR (dB)');
ylabel('Average pilot measurements');
...
export_publication_figure(fig, result_dir, ...
    'fig_stability_guided_training_baselines');
